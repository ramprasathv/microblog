...
from flask_login import current_user, login_user # Flask login extensions
from flask_login import logout_user # Flask logout feature
from flask_login import login_required
from flask import render_template, flash, redirect, url_for # Flask HTML rendering modules
from app.forms import LoginForm # Internal Module: Implements Login page
...
from werkzeug.urls import url_parse # To check if url is relatie or absolute
from app import db # Internal Package: DB handler
from app.forms import RegistrationForm # Internal Module: Implements Registration page
from datetime import datetime # Datetime module
from app.forms import EditProfileForm # Internal Module: Implements Edit Profile page
from app.forms import PostForm # Internal Module: Implements Post form in Index page
